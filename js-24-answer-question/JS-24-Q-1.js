...
const makeUser = (userName, age, profession) => {
  const user = {};

  user.name = userName;
  user.poersonAge = age;
  user.personProfession = profession;

  user.introduce = function () {
    return `Hi, my name is ${userName}. I'm ${age} years old and work as a ${profession}.`;
  };
  return user;
};

const person = makeUser("John Doe", "30", "Web Developer");
